...
from app.models.interest import Interest, InterestTrend, InterestKeyword, InterestLog
...
def get_url():
    """Get database URL from settings - use sync driver for migrations"""
    # Use synchronous MySQL driver for migrations
